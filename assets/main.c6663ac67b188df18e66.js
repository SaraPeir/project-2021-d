...
var fetchWeatherSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__.createSlice)({
  ...
  reducers: {
    ...
    //     ['fetchWeather/fetchByProvId/fulfilled']: (state, { meta, payload })=> {  
    //         console.log('fullfilled: meta, payload', payload)
    //         state.value = payload;
    //        },
    //       [fetchTest.pending]: (state, { meta })=>{
    //         console.log('pending: meta', meta)
    //         state.value = "pending";
    //       },
    //       [fetchTest.rejected]: (state,{meta,payload,error })=>{
    //         state.value = error;
    //       }
    //   },
  ...
  extraReducers: function extraReducers(builder) {
    ...
    builder.addCase(fetchTest.fulfilled, function (state, action) {
      // Add user to the state array
      // console.log('ACTION', action)
      var _ref2 = action.payload || null,
          data = _ref2.data;

      state.value = data;

      if (action.payload.data.title && action.payload.data.today && action.payload.data.tomorrow && action.payload.data.ciudades && action.payload.data.ciudades.length) {
...
//# sourceMappingURL=main.c6663ac67b188df18e66.js.map