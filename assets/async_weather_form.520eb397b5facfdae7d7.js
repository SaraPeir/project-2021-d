...
var WeatherForm = function WeatherForm(_ref) {
  ...
  if (optionValue) {
    provinces.find(function (prov) {
      prov.CAPITAL_PROVINCIA === optionValue;
      prov.CODPROV = codProv;
    });
  }

  console.log('optionValue', optionValue);
  /* const codProv = useSelector((state) => {
      try {
...
//# sourceMappingURL=async_weather_form.520eb397b5facfdae7d7.js.map