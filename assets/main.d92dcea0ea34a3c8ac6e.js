...
var Global = function Global(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement("button", {
    ...
    onClick: function onClick() {
      return dispatch((0,_redux_slices_fetchWeather__WEBPACK_IMPORTED_MODULE_9__.fetchWeather)(provinces));
    }
...
var fetchWeatherSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__.createSlice)({
  ...
  reducers: {
    fetchWeather: function () {
      var _fetchWeather = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(state, _ref) {
        var provinces, response, province, codProv, hasData;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                province = provinces.find(function (prov) {
                  return prov.CAPITAL_PROVINCIA === 'Madrid';
                });
                codProv = province.CODPROV;
                _context.prev = 4;
                _context.next = 7;
                return axios__WEBPACK_IMPORTED_MODULE_3___default().get("https://www.el-tiempo.net/api/json/v2/provincias/".concat(codProv));
...
//# sourceMappingURL=main.d92dcea0ea34a3c8ac6e.js.map