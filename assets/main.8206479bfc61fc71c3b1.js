...
var fetchWeatherThunk = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__.createAsyncThunk)('fetchWeather/fetchByProvId', /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(id, thunkAPI) {
    var response;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_2___default().get("https://www.el-tiempo.net/api/json/v2/provincias/".concat(id));
...
var fetchWeatherSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__.createSlice)({
  ...
  extraReducers: function extraReducers(builder) {
    builder.addCase(fetchWeatherThunk.fulfilled, function (state, action) {
    ...
    }).addCase(fetchWeatherThunk.pending, function (state) {
      state.loading = true;
    }).addCase(fetchWeatherThunk.error, function (state, action) {
      state.loading = true;
    });
  }
});
...
//# sourceMappingURL=main.8206479bfc61fc71c3b1.js.map