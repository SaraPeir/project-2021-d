...
var dataFromCache = client.readQuery({
  query: (0,_apollo_client__WEBPACK_IMPORTED_MODULE_7__.default)(_templateObject2 || (_templateObject2 = (0,_babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_0__.default)(["\n    query getTasks {\n        tasks {\n          _id\n          isDone\n          task\n        }\n    }\n  "])))
}).then(function (result) {
  return console.log('dataFromCache', result);
});
...
//# sourceMappingURL=main.9496b33e70d8dfe90cbc.js.map