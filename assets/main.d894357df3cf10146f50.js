...
var Global = function Global(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(react__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement("button", {
    ...
    onClick: function onClick() {
      return dispatch((0,_redux_slices_fetchWeather__WEBPACK_IMPORTED_MODULE_9__.fetchTest)());
    }
...
var fetchTest = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__.createAsyncThunk)('fetchWeather/fetchByProvId', /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(_, thunkAPI) {
    var response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_3___default().get("https://www.el-tiempo.net/api/json/v2/provincias/28");
...
var fetchWeatherSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__.createSlice)({
  ...
  reducers: {
    fetchWeather: function () {
      var _fetchWeather = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(state) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                if (response.title && response.today && response.tomorrow && response.ciudades && response.ciudades.length) {
                  hasData = true;
                ...
                return _context2.abrupt("return", _objectSpread(_objectSpread({}, state), {}, {
                  provs: fetchTest,
      ...
      function fetchWeather(_x3) {
        return _fetchWeather.apply(this, arguments);
      }

      return fetchWeather;
    }(),
    extraReducers: (_extraReducers = {}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(_extraReducers, 'fetchWeather/fetchByProvId/fulfilled', function fetchWeatherFetchByProvIdFulfilled(state, _ref2) {
      var meta = _ref2.meta,
          payload = _ref2.payload;
      console.log('fullfilled: meta, payload', payload);
      state.value = payload;
    }), (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(_extraReducers, fetchTest.pending, function (state, _ref3) {
      var meta = _ref3.meta;
      console.log('pending: meta', meta);
      state.value = "pending";
    }), (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)(_extraReducers, fetchTest.rejected, function (state, _ref4) {
      var meta = _ref4.meta,
...
var extras = fetchWeatherSlice.extraReducers;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__.configureStore)({
  reducer: {
    ...
    ext: _slices_fetchWeather__WEBPACK_IMPORTED_MODULE_1__.extras
  },
...
//# sourceMappingURL=main.d894357df3cf10146f50.js.map