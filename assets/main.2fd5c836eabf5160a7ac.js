...
var fetchTest = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__.createAsyncThunk)('fetchWeather/fetchByIdStatus', /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(userId, thunkAPI) {
    var response;
  ...
  reducers: {
    ...
    extraReducers: function extraReducers(builder) {
      ...
      builder.addCase(fetchTest.fulfilled, function (state, action) {
        console.log('STATE, ACTION', state, action); // Add user to the state array

        state.provs.push(action.payload);
      });
    }
  }
...
//# sourceMappingURL=main.2fd5c836eabf5160a7ac.js.map