...
var WeatherForm = function WeatherForm(_ref) {
  ...
  var options = [];
  var optionValue;
  var dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__.useDispatch)(); // const [optionValue, setOptionValue] = useState(undefined);

  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined),
      _useState2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useState, 2),
      codProv = _useState2[0],
      setCodProv = _useState2[1];
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", {
    ...
    onChange: function onChange(e) {
      console.log('e.target.value', e.target.value); // setOptionValue(e.target.value)
...
//# sourceMappingURL=async_weather_form.90cb6733ff26787354e4.js.map